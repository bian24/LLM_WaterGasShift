...
factual_correctness, answer_relevance = [], []
...
plt.hist([factual_correctness, answer_relevance], bins=np.arange(0, 1.1, 0.1), label=["Factual Correctness", "Answer Relevance"], alpha=0.7)
plt.xlabel("Score")
