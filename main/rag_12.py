...
pdf_folder1 = os.path.join(parent_dir, 'WGS-PDF1')
pdf_folder2 = os.path.join(parent_dir, 'WGS-PDF2')

# Get all PDF files from both folders
pdf_files1 = glob.glob(f"{pdf_folder1}/*.pdf")
pdf_files2 = glob.glob(f"{pdf_folder2}/*.pdf")
